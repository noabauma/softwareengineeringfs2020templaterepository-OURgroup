...
SocketException::SocketException(const std::string &message, bool inclSysMsg) _GLIBCXX_USE_NOEXCEPT
  : userMessage(message) {
  if (inclSysMsg) {
    userMessage.append(": ");
...
SocketException::~SocketException() _GLIBCXX_TXN_SAFE_DYN _GLIBCXX_USE_NOEXCEPT {
}

const char *SocketException::what() const _GLIBCXX_TXN_SAFE_DYN _GLIBCXX_USE_NOEXCEPT{
